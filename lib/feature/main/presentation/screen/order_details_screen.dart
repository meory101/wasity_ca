...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  @override
  void initState() {
    print(widget.args.orderLocationPoints);
  ...
  getMarkers() async {
    for (var element in widget.args.orderLocationPoints) {
      points.add([
        element[0].toDouble(),
        element[1].toDouble(),
      ]);
    ...
    markers.add(
      Marker(
        ...
        position: LatLng(
          (widget.args.order?.address?.lat ?? 0.0).toDouble(),
          (widget.args.order?.address?.long ?? 0.0).toDouble(),
        ),
      ),
    );
                ...
                children: [
                  Row(
                    children: [
                      ...
                      AppTextWidget(
                        text: widget.args.order?.order?.orderNumber ?? "",
                        fontSize: FontSizeManager.fs14,
                        fontWeight: FontWeight.w500,
                        color: AppColorManager.white,
                      ),
                  ...
                  Row(
                    ...
                    children: [
                      AppTextWidget(
                        text: widget.args.order?.client?.number ?? "",
                        fontSize: FontSizeManager.fs16,
                        fontWeight: FontWeight.w700,
                        color: AppColorManager.white,
                      ),
                      InkWell(
                        ...
                        onTap: () async {
                          await launchUrl(Uri.parse(
                              "tel://${widget.args.order?.client?.number}"));
                        },
                        child: Container(
                  ...
                  Row(
                    children: [
                      ...
                      AppTextWidget(
                        text: widget.args.order?.order?.createdAt ?? "",
                        fontSize: FontSizeManager.fs14,
                        fontWeight: FontWeight.w500,
                        color: AppColorManager.white,
                      ),
                  ...
                  Row(
                    children: [
                      ...
                      AppTextWidget(
                        text:
                            '${widget.args.order?.order?.subTotal.toString() ?? ""} SYP',
                    ...
                    children: [
                      ...
                      AppTextWidget(
                        text: EnumManager.orderStatus[
                                widget.args.order?.order?.statusCode] ??
                            "",
